...
</svg>&nbsp; <span class=""> ${email}</span>&nbsp;&nbsp; <a href="logout"><button class="btn btn-primary">Log Out</button></a> </p>
	 </div>
                ...
                <div class="col-md-6">
                 <!--   <button type="button" class="btn btn-primary btn-lg shadow fs-6" data-bs-toggle="collapse"
                    ...
                    <button class="btn btn-success btn-lg shadow fs-6" data-toggle="modal"><i
                            ...
                            class="text-white text-decoration-none">Create BID</a></button>
                </div>
            </div>
        </div>
            ...
            <tbody>
                <c:forEach var="BiddingData" items="${list}">
                    <tr>
                        ...
                        <td><button class="btn btn-success"> $ ${BiddingData.bidCost}</button></td>
