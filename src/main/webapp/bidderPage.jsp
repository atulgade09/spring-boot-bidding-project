...
<path
		...
		<div> <a href="logout"> <svg xmlns="http://www.w3.org/2000/svg" width="48" height="32" fill="currentColor" class="bi bi-arrow-left-square-fill" viewBox="0 0 16 16">
  <path d="M16 14a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12zm-4.5-6.5H5.707l2.147-2.146a.5.5 0 1 0-.708-.708l-3 3a.5.5 0 0 0 0 .708l3 3a.5.5 0 0 0 .708-.708L5.707 8.5H11.5a.5.5 0 0 0 0-1z"/>
		...
		<a href="myBids" class="text-white text-decoration-none"><button
				...
				Your Raised BIDS</button></a>
					...
					<a href="acceptedBidderBids" class="text-white text-decoration-none"><button
				class="btn btn-warning btn-lg shadow " data-toggle="modal">
				Your Accepted BIDS</button></a>
				...
				<div class="table-title m-0 shadow mb-3 mt-5">
                    ...
                    class="text-white text-decoration-none">Show BID Details</a> -->
							...
							<c:choose>
								...
								<c:otherwise>
									<button class="btn btn-danger btn-lg shadow fs-6"
										data-toggle="modal">
										<b>INACTIVE</b>
									</button>
								</c:otherwise>
