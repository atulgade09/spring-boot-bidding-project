...
<path
		...
		<div>
			<a href="logout"> <svg xmlns="http://www.w3.org/2000/svg"
					width="48" height="32" fill="currentColor"
  ...
  <path
		...
		<br>
		<a href="showAcceptedList"><button
						class="btn btn-primary">ACCEPTED BIDS</button></a> <br> <br>
		<!--    <a href="myBids"
        class="text-white text-decoration-none"><button
            class="btn btn-primary btn-lg shadow " data-toggle="modal">
		...
		<div class="table-title m-0 shadow mb-3">
			<div class="row pt-4 pb-2">
				<div class="col-md-6">
					<!--  <h2 style="padding-top: 5px;"><b>BIDING</b> Details</h2> -->
				</div>
				<div class="col-md-6">
					...
					<button type="button" class="btn btn-primary btn-lg shadow fs-6"
						data-bs-toggle="collapse" data-bs-target="#details"
						style="margin-bottom: 15px;">
						<i class="material-icons">&#xE147;</i>Show BID Details
					</button>
					<!--   <a href="getBiddingList"
                        class="text-white text-decoration-none">Show BID Details</a> -->
					<button class="btn btn-success btn-lg shadow fs-6"
						data-toggle="modal">
						<i class="material-icons">&#xE147;</i><a href="OwnerDataForm"
							class="text-white text-decoration-none">Create BID</a>
					</button>
				</div>
			</div>
		</div>
...
-->
									<!-- <%--  <td>
                    <a href="editOwnerBid/${BiddingData.bidId}" class="edit" data-toggle="modal"><i class="material-icons"
                            data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                    <a href="deleteOwnerBid/${BiddingData.bidId}" class="delete" data-toggle="modal"><i class="material-icons"
                ...
                aria-controls="collapseExample"> See All Bidders </a> -->
